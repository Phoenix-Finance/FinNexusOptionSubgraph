...
export function handleAddFee(event: AddFee): void {
  ...
  entity.payback = event.params.payback
  ...
  // - contract.getAllFeeBalances(...)
  // - contract.getAllRealBalance(...)
  // - contract.getCollateralAndPremiumBalances(...)
  // - contract.getCollateralBalance(...)
  // - contract.getFeeBalance(...)
  // - contract.getFeeRate(...)
  // - contract.getFeeRateAll(...)
  ...
  // - contract.getUserInputCollateral(...)
...
export function handleRedeemFee(event: RedeemFee): void {}

export function handleTransferPayback(event: TransferPayback): void {}
